function CatalogAB_all = absolutePhotometryForAstroImage(OptimizedParams, Config, Args)
    ...
    % Example:
    %   % Sequence 1: Single parameters for all fields
    ...
    %   % Sequence 2: Field-specific parameters from optimizeAllFieldsAI
    ...
    for imageNum = 1:24
        ...
        try
            ...
            % Write result up to AstroImage - now in
            % calculateAbsolutePhotometry
            
            % AstroImageFile(imageNum).CatData.insertCol(NewMagZP, Inf, 'MagZPCorr');
